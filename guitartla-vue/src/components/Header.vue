          ...
          <div class="carrito">
            ...
            <div id="carrito" class="bg-white p-3">
              ...
              <div v-else>
                  ...
                  <tbody>
                    <tr v-for="producto in carrito" :key="producto.id">
                      ...
                      <td class="flex align-items-start gap-4">
                        <button
                          v-on:click="
                            $emit('decrementar-cantidad', producto.id)
                          "
                          type="button"
                          class="btn btn-dark"
                        >
                        ...
                        <button
                          v-on:click="
                            $emit('incrementar-cantidad', producto.id)
                          "
                          type="button"
                          class="btn btn-dark"
                        >
                      ...
                      <td>
                        <button v-on:click="$emit('eliminar-producto', producto.id)" class="btn btn-danger" type="button">X</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <button v-on:click="$emit('vaciar-carrito')" class="btn btn-dark w-100 mt-3 p-2">
                  Vaciar Carrito
                </button>
              </div>
            </div>
